DROP DATABASE IF EXISTS `03_videoteka`;

CREATE DATABASE IF NOT EXISTS `03_videoteka` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `03_videoteka`;
...
INSERT INTO `clanovi` (`ime`, `prezime`, `adresa`, `telefon`, `email`, `clanski_broj`, `password`) VALUES
('Ivan', 'Horvat', 'Vukovarska 202', '0912345678', 'ivan.horvat@example.com', 'CLAN12345', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Ana', 'Kovač', 'Ulica Matije Gupca 15', '0912345679', 'ana.kovac@example.com', 'CLAN12346', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Marko', 'Maric', 'Ulica Ivana Gundulića 5', '0912345680', 'marko.maric@example.com', 'CLAN12347', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Petra', 'Novak', 'Ulica Stjepana Radića 8', '0912345681', 'petra.novak@example.com', 'CLAN12348', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Lucija', 'Jurić', 'Ulica bana Jelačića 7', '0912345682', 'lucija.juric@example.com', 'CLAN12349', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Ivan', 'Perić', 'Trg kralja Tomislava 3', '0912345683', 'ivan.peric@example.com', 'CLAN12350', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Maja', 'Božić', 'Ulica Josipa Broza 9', '0912345684', 'maja.bozic@example.com', 'CLAN12351', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Nikola', 'Kovačević', 'Ulica Ante Starčevića 6', '0912345685', 'nikola.kovacevic@example.com', 'CLAN12352', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Ivana', 'Matić', 'Ulica Josipa Jurja Strossmayera 2', '0912345686', 'ivana.matic@example.com', 'CLAN12353', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Marin', 'Babić', 'Ulica Ljudevita Gaja 10', '0912345687', 'marin.babic@example.com', 'CLAN12354', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Katarina', 'Petrović', 'Ulica Ivana Mažuranića 4', '0912345688', 'katarina.petrovic@example.com', 'CLAN12355', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Tomislav', 'Radić', 'Ulica Pavla Šubića 12', '0912345689', 'tomislav.radic@example.com', 'CLAN12356', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Doris', 'Grgić', 'Trg bana Josipa Jelačića 11', '0912345690', 'doris.grgic@example.com', 'CLAN12357', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Josip', 'Lovrić', 'Ulica Michaela Scumachera 3', '0912345691', 'josip.lovric@example.com', 'CLAN12358', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e'),
('Marta', 'Pavlović', 'Ulica Vladimira Nazora 8', '0912345692', 'marta.pavlovic@example.com', 'CLAN12359', '$2y$10$3UIXL/UfP8sMqVomSB0qSeSyrYViWiWVGO1cUCyNrScl7bziPGF1e');
