            ...
            <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
              ...
              <div class="-ml-4 flex items-center gap-x-4">
                ...
                <div class="flex gap-x-2.5">
                  <img src="https://logosandtypes.com/wp-content/uploads/2023/12/Algebra.png" alt="" class="h-6 w-6 flex-none rounded-full bg-white/10">
          ...
          <article class="flex flex-col items-start justify-between">
            ...
            <div class="max-w-xl">
              ...
              <div class="relative mt-8 flex items-center gap-x-4">
                <img src="https://logosandtypes.com/wp-content/uploads/2023/12/Algebra.png" alt="" class="h-10 w-10 rounded-full bg-gray-100">
