    ...
    @foreach($categories as $category)
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
          <img class="absolute inset-0 h-full w-full object-cover brightness-150 saturate-0" src="{{ $articles[$category->name]['featured']->image }}" alt="">
          ...
          <div class="relative mx-auto max-w-2xl lg:mx-0">
            <p class="text-3xl font-semibold text-white">{{ $articles[$category->name]['featured']->title ?? '' }}</p>
            <figure>
