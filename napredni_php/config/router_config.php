...
return [
    ...
    '/copies/create' => 'Controllers/copies/create.php',
    '/copies/store' => 'Controllers/copies/store.php',
    '/copies/edit' => 'Controllers/copies/edit.php',
    '/copies/update' => 'Controllers/copies/update.php',
