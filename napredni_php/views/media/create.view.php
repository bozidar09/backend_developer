...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/media/store" method="POST">
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="type" name="type" value="<?= $data['tip'] ?? '' ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="coefficient" name="coefficient" value="<?= $data['koeficijent'] ?? '' ?>" required>
