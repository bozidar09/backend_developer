...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/media/update" method="POST">
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="type" name="type" value="<?= $media['tip'] ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="coefficient" name="coefficient" value="<?= $media['koeficijent'] ?>" required>
        ...
        <div class="col-auto">
            ...
            <button class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Spremi medij"><i class="bi bi-floppy"></i></button>
        </div>
    </form>
</main>
