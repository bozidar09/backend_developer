...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/prices/store" method="POST">
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="movie_type" name="movie_type" value="<?= $data['tip_filma'] ?? '' ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="price" name="price" value="<?= $data['cijena'] ?? '' ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="late_fee" name="late_fee" value="<?= $data['zakasnina_po_danu'] ?? '' ?>" required>
        ...
        <div class="col-auto">
            ...
            <button class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Spremi tip filma"><i class="bi bi-floppy"></i></button>
        </div>
    </form>
</main>
