...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/members/store" method="POST">
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="name" name="name" value="<?= $data['ime'] ?? '' ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="surname" name="surname" value="<?= $data['prezime'] ?? '' ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="address" name="address" value="<?= $data['adresa'] ?? '' ?>" >
        ...
        <div class="row mt-3">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="phone" name="phone" value="<?= $data['telefon'] ?? '' ?>">
        ...
        <div class="col-auto">
            ...
            <button class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Spremi člana"><i class="bi bi-floppy"></i></button>
        </div>
    </form>
</main>
